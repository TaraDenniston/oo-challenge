 ...
 *    -  year
 * 
 * Each vehicle instance should have access to a method called honk, which 
 * returns the string “Beep.”
 * 
 * let myFirstVehicle = new Vehicle("Honda", "Monster Truck", 1999);
 * myFirstVehicle.honk(); // "Beep."
 * 
 * Each vehicle instance should have a method called toString, which returns 
 * the string containing the make, model and year.
 * 
 * let myFirstVehicle = new Vehicle("Honda", "Monster Truck", 1999);
 ...
 * each motorcycle instance should have a property called numWheels which has a 
 * value of 2. It should also have a revEngine method which returns “VROOM!!!”
 * 
